...
<@layout.mainLayout active='account' bodyClass='user'; section>
    ...
    <form action="${url.accountUrl}" class="form-horizontal" method="post">
        ...
        <div class="form-group ${messagesPerField.printIfExists('mobile','has-error')}">
            <div class="col-sm-2 col-md-2">
                <label for="mobile" class="control-label">${msg("mobile")}</label> <span class="required">*</span>
            </div>

            <div class="col-sm-10 col-md-10">
                <input type="text" class="form-control" id="mobile" name="user.attributes.mobile" value="${(account.mobile!'')?html}"/>
            </div>
        </div>

        <div class="form-group ${messagesPerField.printIfExists('bloodgroup','has-error')}">
            <div class="col-sm-2 col-md-2">
                <label for="bloodgroup" class="control-label">${msg("bloodgroup")}</label> <span class="required">*</span>
            </div>

            <div class="col-sm-10 col-md-10">
                <input type="text" class="form-control" id="bloodgroup" name="user.attributes.bloodgroup" value="${(account.bloodgroup!'')?html}"/>
            </div>
        </div>
